<div class="modal fade mt-5" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal
    id="modalRepuestoUpdate">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Actualizar Repuesto
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formRepuestoUpdate" method="" action="{{route('repuestos.update')}}">
                    @csrf
                    @method('PATCH')
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control"  name="num_pedido"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" class="form-control"  name="delivery_orden"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" min="0" class="form-control"  name="valor_before_iva"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text"  class="form-control"  name="costo_in"
                                    placeholder="">
                            </div>

                            <div class="form-group col-md-6">
                                <label class="text-dark">Cantidad</label>
                                <input type="text" min="0" class="form-control" required name="cantidad"
                                    placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-12">
                                <input type="submit" class="btn btn-outline-info  btn-sm " id="btnUpdateRepuesto"
                                    value="Enviar">
