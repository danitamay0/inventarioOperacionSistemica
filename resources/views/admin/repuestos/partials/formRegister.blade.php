<div class="modal fade mt-5" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal
    id="modalRepuestoRegister">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Registrar Repuesto
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formRepuestoRegister" method="POST" action="{{route('repuestos.store')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="proveedor_id" class="selectpickerp" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="estado" class="selectpickerp" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <input type="text" tag="0" class="form-control" name="valor_before_iva" placeholder="">
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                <input type="submit" class="btn btn-outline-info  btn-sm " id="btnSaveRepuesto"
                                    value="Enviar">
