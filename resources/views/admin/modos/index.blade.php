...
<div class="row mb-0">
    ...
    <div class="ml-auto d-flex align-items-center secondary-menu text-center m-2">
        ...
        <a href="javascript:void(0)" class="tooltip-wrapper btn btn-circle btn-primary mr-1" data-toggle="modal" data-placement="top"
            data-target="#modalModoRegister" title="Registrar">
    ...
    <div class="col-lg-12">
        <div class="card mb-0">
            ...
            <div class="table-responsive p-3">
                <table class="table align-items-center table-flush table-hover" id="dataTableModos">
                    <thead class="thead">
                        <tr>
                            <th>S. No</th>
                            <th>Modo</th>
...
@include('admin.modos.partials.formUpdate')
@include('admin.modos.partials.formRegister')
@stop

@push('scripts')
<script src="{{ asset('/apis/apiModo.js') }}"></script>
@endpush
