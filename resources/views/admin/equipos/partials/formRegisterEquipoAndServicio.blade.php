                    ...
                    <div class="modal-body" id="xy">
                        <div class="row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="user_id" class="selectInEquiposAddService" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="staff_id" class="selectInEquiposAddService" style="width:100%" required>
                                    @if (isset($users) && count($users)>0)
                                    @foreach ($users as $tecnico)
                                    <option value="{{$tecnico->id}}">{{$tecnico->name}}</option>
                                    @endforeach
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tipo_id" class="selectInEquiposAddService" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="tipo_reparacion" class="selectInEquiposAddService" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="equipo_id" class="selectInEquiposAddService" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="modo_id" class="selectInEquiposAddService" style="width:100%" required>
