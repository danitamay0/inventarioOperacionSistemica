<div class="modal fade mt-5" tabindex="-1" role="dialog" data-backdrop="static" data-ajax-modal
    id="modalPedidoRegister">
    <div class="modal-dialog modal-lg " role="document">
        <div class="modal-content ">

            <div class="card-header text-dark">Registrar Pedido
                <button type="button" class="close" data-dismiss="modal">&times;</button>
            </div>

            <div class="card-body">

                <form id="formPedidoRegister" method="POST" action="{{route('pedidos.store')}}">
                    @csrf
                    <div class="modal-body">
                        <div class="row text-left">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="proveedor_id" class="selectpickerp custom-select" style="width:100%"
                                    required>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <select name="estado" class="selectpickerp custom-select" style="width:100%" required>
                            ...
                            <div class="form-group col-md-6">
                                <input type="submit" class="btn btn-outline-info  btn-sm " id="btnSavePedido"
                                    value="Enviar">
