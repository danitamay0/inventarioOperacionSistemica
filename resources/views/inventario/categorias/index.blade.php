            ...
            <div class="card-header d-flex flex-row align-items-center justify-content-between">
                <h6 class="mr-2 font-weight-bold text-primary ">
                    ...
                    <a href="javascript:void(0)" class="tooltip-wrapper btn btn-circle text-white  btn-primary mr-1"
                        data-toggle="modal" data-placement="top" data-target="#modalCategoriaRegister"
...
@include('inventario.categorias.partials.formUpdate')
@include('inventario.categorias.partials.formRegister')
